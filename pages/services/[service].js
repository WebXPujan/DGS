            ...
            }
            {
               service.map((s)=>(
                <div className="container" key={s.id}>
                    <IntroTextWrap 
                            intro1={s.testimonial.intro1}
                            intro2={s.testimonial.intro2}
                            highlight={s.testimonial.highlight} />
                    <div className="column col-md-12 col-sm-12">
                        <div className="testimonial-inside-service">
                            ...
                            <div className="desc">
                                ...
                                <p className="para">{s.testimonial.desc}</p>
                                <a 
                                        href={s.testimonial.link} className="dg-link"
